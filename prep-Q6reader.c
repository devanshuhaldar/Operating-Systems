...
/* Attaches to the shared memory segment created by prep-Q6writer.c
 *  and waits for data to be available.  Once data is available,
 *   the data is downcased and displayed.
 *
 * The synchronization protocol will be implemented in the first byte
 *  of the shared memory segment as follows:
 *
 *   'R' -- read mode in which this process is reading data
 *           (no writes should occur)
 *
 *   'W' -- write mode in which the other process is writing data
